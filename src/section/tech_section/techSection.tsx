  ...
  return (
    <div className="md:h-[200vh] h-[90vh] overflow-hidden w-full mt-[-200px] relative z-[-1] bg-[#151515]">
      <div className="flex h-full lg:px-[116px] md:px-[60px] px-[16px]">
        ...
        <InfiniteColumnEffect className={`${defaultClassnames} `} speed={0.15}>
          <VueLogo />
          <ReactLogo />
          <NextJsLogo />
        </InfiniteColumnEffect>
        {/* Third column (slowest) */}
        <InfiniteColumnEffect className={`${defaultClassnames} border-l-2`} speed={0.1}>
          <ReactLogo />
          <VueLogo />
          <NextJsLogo />
        </InfiniteColumnEffect>
        {/* Fourth column (fast but slower than first) */}
        <InfiniteColumnEffect className={`${defaultClassnames} md:border-x-2 border-l-2`} speed={0.25}>
          <VueLogo />
          <NextJsLogo />
          <ReactLogo />
        </InfiniteColumnEffect>
